        ...
        <div className="container mt-4 ">
          ...
          <div className="row ">
            <table className="col-11 col-md-7">
              ...
              <tr>
                <td className="halfdone">YadavRam Ji (250/-)</td>
            ...
            >
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Month Of February Expenses</h5>
                  <button
                    type="button"
                    className="close"
                    data-dismiss="modal"
                ...
                <div className="modal-body">
                  <ul className="expenses">
                    <li>Total Collection = Rs 6750/- </li>
                    ...
                    <li>Bulb= Rs 200</li>
                    <li>Intercom = Rs 500</li>
                    <br />
                    {/* ---- Payment---- <br /> */}
                    <br />
                    <b>Total = 25,050 - 3900 = Rs 21,150/- </b>
                  </ul>
                </div>
